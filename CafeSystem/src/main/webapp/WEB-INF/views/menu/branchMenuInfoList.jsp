		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<form action="./branchMenuInfoList" method="post" name="search">
					...
					<div class="x_content">
						...
						<table class="table table-hover">
							...
							<tbody>
								<c:forEach var="menuInfo" items="${menuInfoList}">
									<tr>
										<td><a
											href="${pageContext.request.contextPath}/branchMenuInfoDetail?menuCode=${menuInfo.menuCode}">${menuInfo.menuCode}</a></td>
						...
						<ul class="pager">
							<c:if test="${currentPage > 1}">
								<li class="previous"><a
									href="${pageContext.request.contextPath}/branchMenuInfoList?currentPage=${currentPage-1}">이전</a></li>
							</c:if>
							<c:if test="${currentPage < lastPage}">
								<li class="next"><a
									href="${pageContext.request.contextPath}/branchMenuInfoList?currentPage=${currentPage+1}">다음</a></li>
							</c:if>
						</ul>
					</div>
				</div>
