		...
		<ul class="nav side-menu">
			<li><a><i class="fa fa-building-o"></i> 매장관리 <span
				...
				<ul class="nav child_menu">
					<li><a href="${pageContext.request.contextPath}/#">매장정보</a></li>
			...
			<li><a><i class="fa fa-coffee"></i> 메뉴관리 <span
					class="fa fa-chevron-down"></span></a>
				<ul class="nav child_menu">
					<li><a href="${pageContext.request.contextPath}/#">카페메뉴</a></li>
					<li><a href="${pageContext.request.contextPath}/#">메뉴재료원가</a></li>
					<li><a href="${pageContext.request.contextPath}/#">메뉴총원가</a></li>
				</ul></li>
