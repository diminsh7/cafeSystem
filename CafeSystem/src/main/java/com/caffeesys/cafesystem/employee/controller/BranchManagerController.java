...
public class BranchManagerController {
	...
	public String insertBranchManager(Model model) { 
		...
		List<BranchManager> branchManagerShopCode = BranchManagerDao.selectBranchManagerShopcode();
		model.addAttribute("branchManagerShopCode",branchManagerShopCode);
		System.out.println("[employee.controller.BranchManagerController.java] branchManagerShopCode :" + branchManagerShopCode);
	...
	public String selectBranchManager(Model model) { 
		...
		List<BranchManager> branchManagerList = branchManagerDao.selectBranchManagerList();
